...
@Operation(
	summary = "Responsável buscar e retornar dados completos da conta, caso a mesma seja encontrada.",
	security = @SecurityRequirement(name = OpenAPIConfiguration.SECURITY_APP_NAME))	
@ApiResponses(value= {
	@ApiResponse( 		
		responseCode = "200",
		description = "Retorno de dados completos da conta.",
			content = {@Content(					
...
public @interface GetContaPorIDEndpoint {
